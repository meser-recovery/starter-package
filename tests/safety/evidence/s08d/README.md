...
| Exact-candidate resume active; edit/render/close/workspace locked and cancel exposed | `s08d-speaker-resume-locked-320.png` | `s08d-speaker-resume-locked-390.png` | `s08d-speaker-resume-locked-768.png` | `s08d-speaker-resume-locked-1280.png` |
...
```bash
./venv/bin/python3 tests/safety/browser_smoke.py --base-url http://127.0.0.1:8765 --browser chromium --screenshot-dir /tmp/s08d-acceptance-evidence.8IYC03
```
